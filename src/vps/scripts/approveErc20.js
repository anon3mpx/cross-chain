...
const PRIVATE_KEY = '';
const TOKEN_ADDRESS = ''; // USDC on Base Sepolia
const SPENDER_ADDRESS = ''; // Router on Base Sepolia (for approving router to pull tokens for CCTP test route)
const AMOUNT_RAW = ''; // raw units (USDC 1.0 = 1000000)
