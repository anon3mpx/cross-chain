...
export const ROUTE_METADATA_BY_CHAIN: Record<number, ChainRouteMetadataEntry> = {
  8453: {
    ...
    rails: {
      [Rail.CCTP]: { tokens: { USDC: '0x0000000000000000000000000000000000001001' } },
      [Rail.AXELAR]: {
        tokens: {
  ...
  42161: {
    ...
    rails: {
      [Rail.CCTP]: { tokens: { USDC: '0x0000000000000000000000000000000000002001' } },
      [Rail.AXELAR]: {
        tokens: {
  ...
  84532: {
    ...
    rails: {
      [Rail.CCTP]: { tokens: { USDC: '0x036CbD53842c5426634e7929541eC2318f3dCF7e' } },
      [Rail.AXELAR]: { tokens: { USDC: '0x2f2A9DbFd8c503a0aC56413B774e39030df85331' } },
      [Rail.LAYERZERO]: {
  ...
  421614: {
    ...
    rails: {
      [Rail.CCTP]: { tokens: { USDC: '0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d' } },
      [Rail.AXELAR]: { tokens: { USDC: '0xA2Ba06a76eC793d1Faf23Cc8220A887402b27331' } },
      [Rail.LAYERZERO]: {
  ...
  11155420: {
    ...
    rails: {
      [Rail.CCTP]: { tokens: { USDC: '0x5fd84259d66Cd46123540766Be93DFE6D43130D7' } },
      [Rail.AXELAR]: { tokens: { USDC: '0x2f2A9DbFd8c503a0aC56413B774e39030df85331' } },
      [Rail.LAYERZERO]: {
