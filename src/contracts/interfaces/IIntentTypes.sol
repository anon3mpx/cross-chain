...
library IntentTypes {
    ...
    /// @notice Settlement tokens supported across rails
    enum SettlementToken { USDC, USDT, ETH }
    ...
    struct SwapIntent {
        ...
        uint256 minSrcSwapOut;      // [SECURITY] Min settlement token from src swap (anti-sandwich)
